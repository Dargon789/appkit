import './Cm82hlkb.js'
import './Cm82hlkb.js'
import { c as de, U as re } from './D1u8rsYX.js'
import { aw as ee, O as fe, X as he, N as le, Q as me } from './cxC4FtgZ.js'
          ...
          var a = 1e3,
            ...
            R = {
              ...
              m: function u(r, t) {
                ...
                var i = 12 * (t.year() - r.year()) + (t.month() - r.month()),
                  n = r.clone().add(i, T),
                  o = t - n < 0,
                  s = r.clone().add(i + (o ? -1 : 1), T)
              ...
              p: function (u) {
                return (
                  { M: T, y: b, w, d: p, D, h: $, m: y, s: f, ms: l, Q: I }[u] ||
                  String(u || '')
                    .toLowerCase()
                    .replace(/s$/, '')
                )
              ...
              return (
                  ...
                  ;(this.$d = (function (i) {
                    ...
                    if (typeof n == 'string' && !/Z$/i.test(n)) {
                      ...
                      if (s) {
                        ...
                        return o
                          ? new Date(
                              Date.UTC(s[1], g, s[3] || 1, s[4] || 0, s[5] || 0, s[6] || 0, v)
                            )
                          : new Date(s[1], g, s[3] || 1, s[4] || 0, s[5] || 0, s[6] || 0, v)
                      }
                    }
                    return new Date(n)
                  })(t)),
                  ...
                  var n = this,
                    ...
                    v = function (k, L) {
                      return h.w(
                        n
                          .toDate()
                          [k].apply(n.toDate('s'), (o ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(L)),
                        n
                      )
                    },
                    x = this.$W,
                ...
                (r.$set = function (t, i) {
                  var n,
                    ...
                    (n[l] = s + 'Milliseconds'),
                    n)[o],
                    v = o === p ? this.$D + (i - this.$W) : i
                  if (o === T || o === b) {
                    var x = this.clone().set(D, 1)
                    x.$d[g](v),
                      x.init(),
                      (this.$d = x.set(D, Math.min(this.$D, x.daysInMonth())).$d)
                  } else g && this.$d[g](v)
                ...
                (r.add = function (t, i) {
                  ...
                  if (s === p) return g(1)
                  if (s === w) return g(7)
                  var v = ((n = {}), (n[y] = c), (n[$] = m), (n[f] = a), n)[s] || 1,
                    x = this.$d.getTime() + t * v
                  return h.w(x, this)
                }),
                ...
                (r.format = function (t) {
                  ...
                  var o = t || 'YYYY-MM-DDTHH:mm:ssZ',
                    ...
                    A = n.meridiem,
                    U = function (L, N, V, z) {
                      return (L && (L[N] || L(i, o))) || V[N].slice(0, z)
                    },
                    J = function (L) {
                  ...
                  return o.replace(W, function (L, N) {
                    return (
                      N ||
                      (function (V) {
                        switch (V) {
                ...
                (r.diff = function (t, i, n) {
                  var o,
                    ...
                    g = h.p(i),
                    v = M(t),
                    x = (v.utcOffset() - this.utcOffset()) * c,
                    _ = this - v,
                    F = function () {
                      return h.m(s, v)
                    }
      ...
      (function (e, d) {
        ;(function (a, c) {
          ...
          return function (a, c, m) {
            ...
            ;(m.en.relativeTime = f),
              (l.fromToBase = function (p, w, T, I, b) {
                for (
                  var D,
                    j,
                    q,
                    W = T.$locale().relativeTime || f,
                    B = a.thresholds || [
                      { l: 's', r: 44, d: 'second' },
                      { l: 'm', r: 89 },
                      { l: 'mm', r: 44, d: 'minute' },
                  ...
                  if (((q = D > 0), O <= S.r || !S.r)) {
                    ...
                    var E = W[S.l]
                    b && (O = b('' + O)),
                      (j = typeof E == 'string' ? E.replace('%d', O) : E(O, w, S.l, q))
                    break
                  }
                }
                if (w) return j
...
const ae = {
  ...
  Ne = 3,
  je = ['receive', 'deposit', 'borrow', 'claim'],
  Re = ['withdraw', 'repay', 'burn'],
  ce = {
    getTransactionGroupTitle(e, d) {
      const a = ae.getYear(),
        c = ae.getMonthNameByIndex(d)
      return e === a ? c : `${c} ${e}`
    },
    getTransactionImages(e) {
      const [d, a] = e,
        c = !!d && (e == null ? void 0 : e.every(f => !!f.nft_info)),
        m = (e == null ? void 0 : e.length) > 1
      return (e == null ? void 0 : e.length) === 2 && !c
        ? [this.getTransactionImage(d), this.getTransactionImage(a)]
        : m
          ? e.map(f => this.getTransactionImage(f))
          : [this.getTransactionImage(d)]
    },
    getTransactionImage(e) {
      return { type: ce.getTransactionTransferTokenType(e), url: ce.getTransactionImageURL(e) }
    },
    getTransactionImageURL(e) {
      var m, l, f, y, $
      let d
      const a = !!(e != null && e.nft_info),
        c = !!(e != null && e.fungible_info)
      return (
        e && a
          ? (d =
              (f =
                (l = (m = e == null ? void 0 : e.nft_info) == null ? void 0 : m.content) == null
                  ? void 0
                  : l.preview) == null
                ? void 0
                : f.url)
          : e &&
            c &&
            (d =
              ($ = (y = e == null ? void 0 : e.fungible_info) == null ? void 0 : y.icon) == null
                ? void 0
                : $.url),
        d
      )
    ...
    getTransactionTransferTokenType(e) {
      if (e != null && e.fungible_info) return 'FUNGIBLE'
      if (e != null && e.nft_info) return 'NFT'
    },
    getTransactionDescriptions(e) {
      var T, I, b
      const d = (T = e == null ? void 0 : e.metadata) == null ? void 0 : T.operationType,
        a = e == null ? void 0 : e.transfers,
        c = ((I = e == null ? void 0 : e.transfers) == null ? void 0 : I.length) > 0,
        m = ((b = e == null ? void 0 : e.transfers) == null ? void 0 : b.length) > 1,
        l = c && (a == null ? void 0 : a.every(D => !!(D != null && D.fungible_info))),
        [f, y] = a
      let $ = this.getTransferDescription(f),
        p = this.getTransferDescription(y)
      if (!c)
        return (d === 'send' || d === 'receive') && l
          ? (($ = re.getTruncateString({
            ...
            [$, p])
          : [e.metadata.status]
      if (m) return a.map(D => this.getTransferDescription(D))
      let w = ''
    ...
    getTransferDescription(e) {
      ...
      return (
        e &&
          (e != null && e.nft_info
            ? (d = ((a = e == null ? void 0 : e.nft_info) == null ? void 0 : a.name) || '-')
            : e != null && e.fungible_info && (d = this.getFungibleTransferDescription(e) || '-')),
        d
      )
    },
    getFungibleTransferDescription(e) {
      ...
      return e
        ? [
            this.getQuantityFixedValue(e == null ? void 0 : e.quantity.numeric),
            (c = e == null ? void 0 : e.fungible_info) == null ? void 0 : c.symbol
          ]
            .join(' ')
            .trim()
        : null
...
var Ue = function (e, d, a, c) {
  var m = arguments.length,
    l = m < 3 ? d : c === null ? (c = Object.getOwnPropertyDescriptor(d, a)) : c,
    f
  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
    l = Reflect.decorate(e, d, a, c)
  else
    for (var y = e.length - 1; y >= 0; y--)
      (f = e[y]) && (l = (m < 3 ? f(l) : m > 3 ? f(d, a, l) : f(d, a)) || l)
...
te.styles = [he, Ye]
te = Ue([de('wui-transaction-list-item-loader')], te)
export { ae as D, ce as T }
