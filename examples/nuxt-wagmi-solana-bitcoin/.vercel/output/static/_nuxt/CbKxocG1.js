...
import './Byf3mnWf.js'
import './CmZgvnX6.js'
import { c as g, o as k, r as p, n as w } from './D1u8rsYX.js'
import './D5z3hTdP.js'
import { e as H, n as V } from './DFaAtWOZ.js'
import './DsbIaR_i.js'
import './JuF9HxfP.js'
import {
  a1 as D,
...
import { N as z } from './r3wKis81.js'

import { r as p, c as g, n as w, o as k } from './D1u8rsYX.js'
import { N as z } from './r3wKis81.js'
import { e as H, n as V } from './DFaAtWOZ.js'
import './DsbIaR_i.js'
import './JuF9HxfP.js'
...
let v = class extends f {
      ...
      ;(this.iframe.style.height = `${$}px`),
        ...
        t && t <= 430
          ...
          : ((this.iframe.style.width = `${A}px`),
            ...
            (this.iframe.style.top = `calc(50% - ${$ / 2}px + ${Y / 2}px)`),
  ...
  async syncTheme() {
    ...
    if (e) {
      const i = E.getSnapshot().themeMode,
        n = E.getSnapshot().themeVariables
      await e.provider.syncTheme({ themeVariables: n, w3mThemeVariables: W(n, i) })
    }
  }
}
v.styles = F
O([p()], v.prototype, 'ready', void 0)
v = O([g('w3m-approve-transaction-view')], v)
...
let u = class extends f {
  ...
  async onSubmitName() {
    ...
    try {
      ...
      const t = `${this.name}${S.WC_NAME_SUFFIX}`
      y.sendEvent({
        type: 'track',
        event: 'REGISTER_NAME_INITIATED',
        properties: {
          isSmartAccount:
            ((i = h.state.preferredAccountTypes) == null ? void 0 : i[e]) ===
            T.ACCOUNT_TYPES.SMART_ACCOUNT,
          ensName: t
        }
      }),
        await c.registerName(t),
        y.sendEvent({
          type: 'track',
          event: 'REGISTER_NAME_SUCCESS',
          properties: {
            isSmartAccount:
              ((n = h.state.preferredAccountTypes) == null ? void 0 : n[e]) ===
              T.ACCOUNT_TYPES.SMART_ACCOUNT,
            ensName: t
          }
        })
      ...
      M.showError(t.message),
        y.sendEvent({
          ...
          properties: {
            isSmartAccount:
              ((s = h.state.preferredAccountTypes) == null ? void 0 : s[e]) ===
              T.ACCOUNT_TYPES.SMART_ACCOUNT,
            ensName: `${this.name}${S.WC_NAME_SUFFIX}`,
...
C.styles = K
C = X([g('w3m-register-account-name-success-view')], C)
export {
