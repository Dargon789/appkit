import './4J_2vLEF.js'
import './CgL49DcC.js'
import { n as C, c as N, U as O, o as S, r as m } from './D1u8rsYX.js'
import './D5z3hTdP.js'
import {
  X as $,
  a6 as A,
...
`
var b = function (n, e, r, i) {
  var s = arguments.length,
    t = s < 3 ? e : i === null ? (i = Object.getOwnPropertyDescriptor(e, r)) : i,
    o
  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
    t = Reflect.decorate(n, e, r, i)
  else
    for (var a = n.length - 1; a >= 0; a--)
      (o = n[a]) && (t = (s < 3 ? o(t) : s > 3 ? o(e, r, t) : o(e, r)) || t)
...
p.styles = [$, A, _]
b([C({ type: Array })], p.prototype, 'networkImages', void 0)
b([C()], p.prototype, 'text', void 0)
p = b([N('wui-compatible-network')], p)
const E = x`
...
let c = class extends k {
  ...
  networkTemplate() {
    ...
    if (
      ((o = this.preferredAccountTypes) == null
        ? void 0
        : o[i == null ? void 0 : i.chainNamespace]) === T.ACCOUNT_TYPES.SMART_ACCOUNT &&
      r
    )
      return i
    ...
    const t = (
      (a =
        e == null
          ...
          : e.filter(f => {
              var y
              return (y = f == null ? void 0 : f.assets) == null ? void 0 : y.imageId
            })) == null
        ? void 0
        : a.slice(0, 5)
    )
      .map(g.getNetworkImage)
      .filter(Boolean)
  ...
  onCopyClick() {
    try {
      this.address && (I.copyToClopboard(this.address), h.showSuccess('Address copied'))
    } catch {
...
d([m()], c.prototype, 'preferredAccountTypes', void 0)
c = d([N('w3m-wallet-receive-view')], c)
