...
const suspectProtoRx$1 =
  /"(?:_|\\u0{2}5[Ff]){2}(?:p|\\u0{2}70)(?:r|\\u0{2}72)(?:o|\\u0{2}6[Ff])(?:t|\\u0{2}74)(?:o|\\u0{2}6[Ff])(?:_|\\u0{2}5[Ff]){2}"\s*:/
const suspectConstructorRx$1 =
...
const c = class {
  ...
  constructor(e = new i$1(), t = new l$1()) {
    Object.assign(this, e), Object.assign(this, t), (this._destroy = g(e._destroy, t._destroy))
  }
}
function _() {
...
const C = new Set([101, 204, 205, 304])
async function b(n, e) {
  ...
  ;(t.method = e.method || 'GET'),
    ...
    await n(t, r)
  let a = r._data
  ;(C.has(r.statusCode) || t.method.toUpperCase() === 'HEAD') &&
...
function getEnv(key, opts) {
  ...
  return destr$1(process.env[opts.prefix + envKey] ?? process.env[opts.altPrefix + envKey])
}
...
const _inlineRuntimeConfig = {
  app: {
    baseURL: '/',
    buildId: '3c93e709-dc82-4e52-b165-301421a24c5c',
...
const _lazy_migoS7 = () => import('../routes/renderer.mjs')

const handlers = [
  {
    route: '/__nuxt_error',
    handler: _lazy_migoS7,
    lazy: true,
    middleware: false,
    method: undefined
  },
...
function createNitroApp() {
  ...
  const localFetch = (input, init) => {
    ...
    return O(nodeHandler, input, init).then(response => normalizeFetchResponse(response))
  }
