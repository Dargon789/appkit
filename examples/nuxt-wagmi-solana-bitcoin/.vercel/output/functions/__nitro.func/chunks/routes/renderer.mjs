...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"AppKit Nuxt Wagmi-Solana-Bitcoin Example"}],"link":[{"id":"favicon","rel":"icon","href":"/favicon-dark.png","media":"(prefers-color-scheme: light)"},{"id":"favicon","rel":"icon","href":"/favicon.png","media":"(prefers-color-scheme: dark)"}],"style":[],"script":[],"noscript":[],"title":"AppKit Nuxt Wagmi-Solana-Bitcoin Example"};
