import{q as re,s as J,B as Y,t as V,j as U,c as ie,A as _,u as se,v as ne,w as oe,i as R,r as y,x as c,y as B,z as C,O as D,M as I,p as ae,e as Z,W as ee,R as E,d as q,a as K,k as ce,S as M,T as le}from"./index-DVkBgnkX.js";import{n as p,c as g,o as m,r as d}from"./if-defined-DVOmkLu5.js";import{D as ue,T as de}from"./index-kA5-QyMM.js";import"./index-Cxc8tIRM.js";import"./index-QpqlfPgl.js";import"./index-B2osUT2V.js";import"./index-vgifefJD.js";import"./index-C5GW1wiz.js";import"./index-DeEXhxyT.js";import"./index-Cn1TwpSs.js";import"./index-BfDAOq8h.js";import"./index-CTojmOJx.js";const N={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},F={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},pe={providers:J,selectedProvider:null,error:null,purchaseCurrency:N,paymentCurrency:F,purchaseCurrencies:[N],paymentCurrencies:[],quotesLoading:!1},l=re(pe),u={state:l,subscribe(s){return oe(l,()=>s(l))},subscribeKey(s,e){return ne(l,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=U.state.activeChain===ie.CHAIN.SOLANA?"SOL":"USDC",t=_.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",se),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}l.selectedProvider=s},setPurchaseCurrency(s){l.purchaseCurrency=s},setPaymentCurrency(s){l.paymentCurrency=s},setPurchaseAmount(s){this.state.purchaseAmount=s},setPaymentAmount(s){this.state.paymentAmount=s},async getAvailableCurrencies(){const s=await Y.getOnrampOptions();l.purchaseCurrencies=s.purchaseCurrencies,l.paymentCurrencies=s.paymentCurrencies,l.paymentCurrency=s.paymentCurrencies[0]||F,l.purchaseCurrency=s.purchaseCurrencies[0]||N,await V.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await V.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;l.quotesLoading=!0;try{const t=await Y.getOnrampQuote({purchaseCurrency:l.purchaseCurrency,paymentCurrency:l.paymentCurrency,amount:((s=l.paymentAmount)==null?void 0:s.toString())||"0",network:(e=l.purchaseCurrency)==null?void 0:e.symbol});return l.quotesLoading=!1,l.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return l.error=t.message,l.quotesLoading=!1,null}finally{l.quotesLoading=!1}},resetState(){l.providers=J,l.selectedProvider=null,l.error=null,l.purchaseCurrency=N,l.paymentCurrency=F,l.purchaseCurrencies=[N],l.paymentCurrencies=[],l.paymentAmount=void 0,l.purchaseAmount=void 0,l.quotesLoading=!1}},he=R`
  :host {
    width: 100%;
  }
...
`;var W=function(s,e,t,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(r=(n<3?o(r):n>3?o(e,t,r):o(e,t))||r);return n>3&&r&&Object.defineProperty(e,t,r),r};let O=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.paymentCurrency,this.currencies=u.state.paymentCurrencies,this.currencyImages=C.state.currencyImages,this.checked=!1,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),C.subscribeKey("currencyImages",e=>this.currencyImages=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=D.state,i=(a=D.state.features)==null?void 0:a.legalCheckbox,o=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var i;return c`
      ...
      `})}selectCurrency(e){e&&(u.setPaymentCurrency(e),I.close())}onCheckboxChange(e){this.checked=!!e.detail}};O.styles=we;W([d()],O.prototype,"selectedCurrency",void 0);W([d()],O.prototype,"currencies",void 0);W([d()],O.prototype,"currencyImages",void 0);W([d()],O.prototype,"checked",void 0);O=W([g("w3m-onramp-fiat-select-view")],O);const ye=R`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
...
`;var z=function(s,e,t,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(r=(n<3?o(r):n>3?o(e,t,r):o(e,t))||r);return n>3&&r&&Object.defineProperty(e,t,r),r};let k=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.purchaseCurrencies,this.tokens=u.state.purchaseCurrencies,this.tokenImages=C.state.tokenImages,this.checked=!1,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),C.subscribeKey("tokenImages",e=>this.tokenImages=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=D.state,i=(a=D.state.features)==null?void 0:a.legalCheckbox,o=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>{var i;return c`
      ...
      `})}selectToken(e){e&&(u.setPurchaseCurrency(e),I.close())}onCheckboxChange(e){this.checked=!!e.detail}};k.styles=ve;z([d()],k.prototype,"selectedCurrency",void 0);z([d()],k.prototype,"tokens",void 0);z([d()],k.prototype,"tokenImages",void 0);z([d()],k.prototype,"checked",void 0);k=z([g("w3m-onramp-token-select-view")],k);const xe=R`
  @keyframes shake {
    0% {
...
`;var P=function(s,e,t,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(r=(n<3?o(r):n>3?o(e,t,r):o(e,t))||r);return n>3&&r&&Object.defineProperty(e,t,r),r};const Ae={USD:"$",EUR:"€",GBP:"£"},Pe=[100,250,500,1e3];let x=class extends y{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=U.state.activeCaipAddress,this.loading=I.state.loading,this.paymentCurrency=u.state.paymentCurrency,this.paymentAmount=u.state.paymentAmount,this.purchaseAmount=u.state.purchaseAmount,this.quoteLoading=u.state.quotesLoading,this.unsubscribe.push(U.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),I.subscribeKey("loading",e=>{this.loading=e}),u.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
    ...
    `}templateButton(){return this.caipAddress?c`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||I.open({view:"OnRampProviders"})}openModal(){I.open({view:"Connect"})}async onPaymentAmountChange(e){u.setPaymentAmount(Number(e.detail)),await u.getQuote()}async selectPresetAmount(e){u.setPaymentAmount(e),await u.getQuote()}};x.styles=Re;P([p({type:Boolean})],x.prototype,"disabled",void 0);P([d()],x.prototype,"caipAddress",void 0);P([d()],x.prototype,"loading",void 0);P([d()],x.prototype,"paymentCurrency",void 0);P([d()],x.prototype,"paymentAmount",void 0);P([d()],x.prototype,"purchaseAmount",void 0);P([d()],x.prototype,"quoteLoading",void 0);x=P([g("w3m-onramp-widget")],x);export{f as W3mBuyInProgressView,$ as W3mOnRampActivityView,G as W3mOnRampProvidersView,O as W3mOnrampFiatSelectView,k as W3mOnrampTokensView,x as W3mOnrampWidget,X as W3mWhatIsABuyView};
