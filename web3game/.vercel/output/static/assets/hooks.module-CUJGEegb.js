...
function K(e, _, t) {
  var n,
    ...
    r,
    i = {}
  for (r in _) r == 'key' ? (n = _[r]) : r == 'ref' ? (u = _[r]) : (i[r] = _[r])
  if (
    (arguments.length > 2 && (i.children = arguments.length > 3 ? L.call(arguments, 2) : t),
    typeof e == 'function' && e.defaultProps != null)
  )
    for (r in e.defaultProps) i[r] === void 0 && (i[r] = e.defaultProps[r])
...
function I_(e, _, t, n, u) {
  ...
  for (e.__k = new Array(u), r = 0; r < u; r++)
    (i = _[r]) != null && typeof i != 'boolean' && typeof i != 'function'
      ? ((f = r + p),
        ((i = e.__k[r] =
          typeof i == 'string' ||
          typeof i == 'number' ||
          ...
          i.constructor == String
            ...
            : W(i)
              ? A(j, { children: i }, null, null, null)
              : i.constructor === void 0 && i.__b > 0
                ? A(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v)
                : i).__ = e),
        (i.__b = e.__b + 1),
        (c = null),
        (l = i.__i = R_(i, t, f, o)) !== -1 && (o--, (c = t[l]) && (c.__u |= 2)),
        c == null || c.__v === null
          ? (l == -1 && (u > a ? p-- : u < a && p++), typeof i.type != 'function' && (i.__u |= 4))
          : l != f && (l == f - 1 ? p-- : l == f + 1 ? p++ : (l > f ? p-- : p++, (i.__u |= 4))))
      : (e.__k[r] = null)
  if (o)
    for (r = 0; r < a; r++)
...
function R_(e, _, t, n) {
  var u,
    ...
    c = e.type,
    f = _[t]
  if ((f === null && e.key == null) || (f && i == f.key && c === f.type && (2 & f.__u) == 0))
    return t
  if (n > (f != null && (2 & f.__u) == 0 ? 1 : 0))
    for (u = t - 1, r = t + 1; u >= 0 || r < _.length; ) {
      if (u >= 0) {
        if ((f = _[u]) && (2 & f.__u) == 0 && i == f.key && c === f.type) return u
        u--
      }
      if (r < _.length) {
        if ((f = _[r]) && (2 & f.__u) == 0 && i == f.key && c === f.type) return r
        r++
      }
    }
  return -1
  ...
  _: if (_ == 'style')
    if (typeof t == 'string') e.style.cssText = t
      ...
      if ((typeof n == 'string' && (e.style.cssText = n = ''), n))
        for (_ in n) (t && _ in t) || i_(e.style, _, '')
      if (t) for (_ in t) (n && t[_] === n[_]) || i_(e.style, _, t[_])
    }
  else if (_[0] == 'o' && _[1] == 'n')
    (r = _ != (_ = _.replace($_, '$1'))),
      (_ =
      ...
      t
        ? n
          ? (t.t = n.t)
          : ((t.t = Y), e.addEventListener(_, r ? J : G, r))
...
function __(e, _, t, n, u, r, i, c, f, l) {
  ...
  _: if (typeof $ == 'function')
    try {
      if (
        ...
        if (
          ...
          !o.__e &&
            ((o.shouldComponentUpdate != null && o.shouldComponentUpdate(d, o.__s, x) === !1) ||
              _.__v == t.__v))
        ) {
          for (
    ...
    r == null && _.__v == t.__v
      ...
      : (c = _.__e = q_(t.__e, _, t, n, u, r, i, f, l))
...
function q_(e, _, t, n, u, r, i, c, f) {
  ...
  if (v === null) b === d || (c && e.data === d) || (e.data = d)
    ...
    if (((r = r && L.call(e.childNodes)), (b = t.props || F), !c && r != null))
      for (b = {}, l = 0; l < e.attributes.length; l++) b[(s = e.attributes[l]).name] = s.value
    for (l in b)
      if (((s = b[l]), l != 'children')) {
        ...
        l == 'children'
          ...
          : l == 'dangerouslySetInnerHTML'
            ...
            : l == 'value'
              ...
              : l == 'checked'
                ? (k = s)
                : (c && typeof s != 'function') || b[l] === s || R(e, l, s, b[l], u)
    if (a)
    ...
    c ||
      ...
      v == 'progress' && g == null
        ...
        : g !== void 0 &&
          (g !== e[l] || (v == 'progress' && !g) || (v == 'option' && g !== b[l])) &&
          R(e, l, g, b[l], u),
      (l = 'checked'),
...
function B_(e, _, t) {
  var n,
    ...
    i,
    c = w({}, e.props)
  for (r in (e.type && e.type.defaultProps && (i = e.type.defaultProps), _))
    r == 'key'
      ? (n = _[r])
      : r == 'ref'
        ? (u = _[r])
        : (c[r] = _[r] === void 0 && i !== void 0 ? i[r] : _[r])
  return (
          ...
          try {
            if (
              ((r = u.constructor) &&
                ...
                (u.setState(r.getDerivedStateFromError(e)), (i = u.__d)),
              u.componentDidCatch != null && (u.componentDidCatch(e, n || {}), (i = u.__d)),
              i)
            )
              return (u.__E = u)
          } catch (c) {
