import { r as c, n as d, c as m, o as q, U as v } from './if-defined-DVOmkLu5.js'
import './index-B2osUT2V.js'
import './index-BIRMkK39.js'
import './index-BfDAOq8h.js'
import { n as O, e as U } from './index-Cn1TwpSs.js'
...
import { n as d, r as c, c as m, U as v, o as q } from './if-defined-DVOmkLu5.js'
import { e as U, n as O } from './index-Cn1TwpSs.js'
import './index-Cxc8tIRM.js'
import './index-DeEXhxyT.js'
import './index-BIRMkK39.js'
import './index-BfDAOq8h.js'
...
var E = function (o, e, i, n) {
  var r = arguments.length,
    t = r < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, i)) : n,
    s
  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
    t = Reflect.decorate(o, e, i, n)
  else
    for (var l = o.length - 1; l >= 0; l--)
      (s = o[l]) && (t = (r < 3 ? s(t) : r > 3 ? s(e, i, t) : s(e, i)) || t)
...
let P = class extends w {
  constructor() {
    super(...arguments),
      ...
      (this.pasting = !1),
      (this.onDebouncedSearch = z.debounce(async e => {
        const i = await H.getEnsAddress(e)
        if ((a.setLoading(!1), i)) {
          a.setReceiverProfileName(e), a.setReceiverAddress(i)
          const n = await H.getEnsAvatar(e)
          a.setReceiverProfileImageUrl(n || void 0)
        } else
          a.setReceiverAddress(e),
...
${this.value ?? ''}</textarea
  ...
  async focusInput() {
    ...
    this.instructionElementRef.value &&
      ...
      (e = this.inputElementRef.value) == null || e.focus(),
  ...
  async focusInstruction() {
    ...
    this.instructionElementRef.value &&
      ...
      (e = this.inputElementRef.value) == null || e.blur())
  }
  ...
  async onPasteClick() {
    ...
    a.setReceiverAddress(e), this.focusInput()
  }
  onInputChange(e) {
    this.pasting = !1
    const i = e.target
...
P.styles = M
E([d()], P.prototype, 'value', void 0)
E([c()], P.prototype, 'instructionHidden', void 0)
E([c()], P.prototype, 'pasting', void 0)
P = E([m('w3m-input-address')], P)
const Y = /[.*+?^${}()|[\]\\]/gu,
  K = /[0-9,.]/u,
  J = f`
  :host {
...
T.styles = [W, V, J]
j([d({ type: Boolean })], T.prototype, 'disabled', void 0)
j([d({ type: String })], T.prototype, 'value', void 0)
j([d({ type: String })], T.prototype, 'placeholder', void 0)
T = j([m('wui-input-amount')], T)
const Q = f`
  :host {
    width: 100%;
    height: 100px;
...
let k = class extends w {
  ...
  onInputChange(e) {
    a.setTokenAmount(e.detail)
  }
  onMaxClick() {
    if (this.token && typeof this.gasPrice < 'u') {
      const e =
          this.token.address === void 0 ||
          Object.values(L.NATIVE_TOKEN_ADDRESS).some(r => {
            var t
            return ((t = this.token) == null ? void 0 : t.address) === r
          }),
        i = N.bigNumber(this.gasPrice).div(
          N.bigNumber(10).pow(Number(this.token.quantity.decimals))
        ),
        n = e
          ? N.bigNumber(this.token.quantity.numeric).minus(i)
          : N.bigNumber(this.token.quantity.numeric)
      a.setTokenAmount(Number(n.toFixed(20)))
    }
  }
  onBuyClick() {
    b.push('OnRampProviders')
  }
}
k.styles = Q
A([d({ type: Object })], k.prototype, 'token', void 0)
A([d({ type: Number })], k.prototype, 'sendTokenAmount', void 0)
A([d({ type: Number })], k.prototype, 'gasPriceInUSD', void 0)
A([d({ type: Number })], k.prototype, 'gasPrice', void 0)
k = A([m('w3m-input-token')], k)
const X = f`
  :host {
    display: block;
  }
...
let p = class extends w {
  constructor() {
    super(),
      ...
      (this.gasPrice = a.state.gasPrice),
  ...
  async fetchBalances() {
    await a.fetchTokenBalance(), a.fetchNetworkBalance()
  }
  async fetchNetworkPrice() {
    await F.getNetworkTokenPrice()
    const e = await F.getInitialGasPrice()
    e != null &&
      e.gasPrice &&
      e != null &&
      e.gasPriceInUSD &&
      (a.setGasPrice(e.gasPrice), a.setGasPriceInUsd(e.gasPriceInUSD))
  }
  onButtonClick() {
    b.push('WalletSendPreview')
  }
  getMessage() {
    var e
    ;(this.message = 'Preview Send'),
      this.receiverAddress &&
        !z.isAddress(this.receiverAddress, D.state.activeChain) &&
        (this.message = 'Invalid Address'),
      this.receiverAddress || (this.message = 'Add Address'),
      a.hasInsufficientGasFunds() && (this.message = 'Insufficient Gas Funds'),
...
p.styles = X
g([c()], p.prototype, 'token', void 0)
g([c()], p.prototype, 'sendTokenAmount', void 0)
g([c()], p.prototype, 'receiverAddress', void 0)
g([c()], p.prototype, 'receiverProfileName', void 0)
g([c()], p.prototype, 'loading', void 0)
g([c()], p.prototype, 'gasPriceInUSD', void 0)
g([c()], p.prototype, 'gasPrice', void 0)
g([c()], p.prototype, 'message', void 0)
p = g([m('w3m-wallet-send-view')], p)
const Z = f`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
let y = class extends w {
  constructor() {
    super(),
      ...
      (this.search = ''),
      (this.onDebouncedSearch = z.debounce(e => {
        this.search = e
      })),
      this.unsubscribe.push(
        a.subscribe(e => {
  ...
  templateTokens() {
    ...
    return (
      (this.tokens =
        (e = this.tokenBalances) == null
          ? void 0
          : e.filter(n => {
              var r
              return (
                n.chainId === ((r = D.state.activeCaipNetwork) == null ? void 0 : r.caipNetworkId)
              )
            })),
      this.search
        ? (this.filteredTokens =
            (i = this.tokenBalances) == null
              ? void 0
              : i.filter(n => n.name.toLowerCase().includes(this.search.toLowerCase())))
  ...
  handleTokenClick(e) {
    a.setToken(e), a.setTokenAmount(void 0), b.goBack()
  }
}
y.styles = Z
I([c()], y.prototype, 'tokenBalances', void 0)
I([c()], y.prototype, 'tokens', void 0)
I([c()], y.prototype, 'filteredTokens', void 0)
I([c()], y.prototype, 'search', void 0)
y = I([m('w3m-wallet-send-select-token-view')], y)
const ee = f`
  :host {
    display: flex;
...
$.styles = [W, V, ee]
R([d()], $.prototype, 'text', void 0)
R([d()], $.prototype, 'address', void 0)
R([d()], $.prototype, 'imageSrc', void 0)
R([d({ type: Boolean })], $.prototype, 'isAddress', void 0)
$ = R([m('wui-preview-item')], $)
const te = f`
  :host {
    display: flex;
...
C.styles = [W, V, te]
_([d()], C.prototype, 'imageSrc', void 0)
_([d()], C.prototype, 'textTitle', void 0)
_([d()], C.prototype, 'textValue', void 0)
C = _([m('wui-list-content')], C)
const ie = f`
  :host {
    display: flex;
    width: auto;
...
let S = class extends w {
  ...
  networkTemplate() {
    var e
    return (e = this.caipNetwork) != null && e.name
      ? u` <wui-list-content
  ...
  onNetworkClick(e) {
    e && b.push('Networks', { network: e })
  }
}
S.styles = ie
B([d()], S.prototype, 'receiverAddress', void 0)
B([d({ type: Object })], S.prototype, 'caipNetwork', void 0)
B([d({ type: Number })], S.prototype, 'networkFee', void 0)
S = B([m('w3m-wallet-send-details')], S)
const ne = f`
  wui-avatar,
  wui-image {
    display: ruby;
  ...
  constructor() {
    super(),
      ...
      this.unsubscribe.push(
        ...
        D.subscribeKey('activeCaipNetwork', e => (this.caipNetwork = e))
      )
  }
  disconnectedCallback() {
    this.unsubscribe.forEach(e => e())
...
h.styles = ne
x([c()], h.prototype, 'token', void 0)
x([c()], h.prototype, 'sendTokenAmount', void 0)
x([c()], h.prototype, 'receiverAddress', void 0)
x([c()], h.prototype, 'receiverProfileName', void 0)
x([c()], h.prototype, 'receiverProfileImageUrl', void 0)
x([c()], h.prototype, 'gasPriceInUSD', void 0)
x([c()], h.prototype, 'caipNetwork', void 0)
h = x([m('w3m-wallet-send-preview-view')], h)
export { y as W3mSendSelectTokenView, h as W3mWalletSendPreviewView, p as W3mWalletSendView }
