import { c as we, n as z } from './if-defined-DVOmkLu5.js'
import { K as de, b as ge, i as he, x as j, r as me, F as x } from './index-DVkBgnkX.js'
import './index-QpqlfPgl.js'

import { n as z, c as we } from './if-defined-DVOmkLu5.js'
import './index-QpqlfPgl.js'
var K = {},
  tt,
  Tt
...
function ye() {
  ...
  return (
    (o.prototype = {
      ...
      put: function (r, i) {
        for (let n = 0; n < i; n++) this.putBit(((r >>> (i - n - 1)) & 1) === 1)
      },
      ...
      putBit: function (r) {
        ...
        this.buffer.length <= i && this.buffer.push(0),
          r && (this.buffer[i] |= 128 >>> this.length % 8),
          this.length++
      }
    }),
    (rt = o),
...
function Ce() {
  ...
  function o(r) {
    ...
    ;(this.size = r),
      (this.data = new Uint8Array(r * r)),
      (this.reservedBit = new Uint8Array(r * r))
  }
  return (
      ...
      (function (o) {
        ...
        ;(o.getRowColCoords = function (n) {
          ...
          const t = Math.floor(n / 7) + 2,
            e = r(n),
            s = e === 145 ? 26 : Math.ceil((e - 13) / (2 * t - 2)) * 2,
            a = [e - 7]
    ...
    Ut ||
      ...
      (function (o) {
        ...
        ;(o.isValid = function (t) {
          ...
          (o.getPenaltyN1 = function (t) {
            ...
            for (let A = 0; A < e; A++) {
              ...
              for (let C = 0; C < e; C++) {
                let h = t.get(A, C)
                h === c ? a++ : (a >= 5 && (s += r.N1 + (a - 5)), (c = h), (a = 1)),
                  (h = t.get(C, A)),
                  h === m ? u++ : (u >= 5 && (s += r.N1 + (u - 5)), (m = h), (u = 1))
              }
          ...
          (o.getPenaltyN3 = function (t) {
            ...
            for (let c = 0; c < e; c++) {
              a = u = 0
              for (let m = 0; m < e; m++)
                (a = ((a << 1) & 2047) | t.get(c, m)),
                  m >= 10 && (a === 1488 || a === 93) && s++,
                  (u = ((u << 1) & 2047) | t.get(m, c)),
                  m >= 10 && (u === 1488 || u === 93) && s++
            }
            return s * r.N3
          }),
        ...
        ;(o.applyMask = function (t, e) {
          const s = e.size
          for (let a = 0; a < s; a++)
            for (let u = 0; u < s; u++) e.isReserved(u, a) || e.xor(u, a, i(t, u, a))
        }),
          (o.getBestMask = function (t, e) {
            ...
            for (let c = 0; c < s; c++) {
              e(c), o.applyMask(c, t)
              const m =
                o.getPenaltyN1(t) + o.getPenaltyN2(t) + o.getPenaltyN3(t) + o.getPenaltyN4(t)
...
function Ae() {
  ...
  return (
    (function () {
      let n = 1
      for (let t = 0; t < 255; t++) (o[t] = n), (r[n] = t), (n <<= 1), n & 256 && (n ^= 285)
      ...
      (function (o) {
        ...
        ;(o.mul = function (n, t) {
          ...
          for (let s = 0; s < n.length; s++)
            for (let a = 0; a < t.length; a++) e[s + a] ^= r.mul(n[s], t[a])
          return e
        }),
          (o.mod = function (n, t) {
            ...
            for (; e.length - t.length >= 0; ) {
              const s = e[0]
              for (let u = 0; u < t.length; u++) e[u] ^= r.mul(t[u], s)
              let a = 0
          ...
          (o.generateECPolynomial = function (n) {
            ...
            for (let e = 0; e < n; e++) t = o.mul(t, new Uint8Array([1, r.exp(e)]))
            return t
          })
      })(at)),
    at
...
function ue() {
  ...
  ;(L.KANJI = new RegExp(i, 'g')),
    ...
    (L.BYTE = new RegExp(n, 'g')),
    (L.NUMERIC = new RegExp(o, 'g')),
    (L.ALPHANUMERIC = new RegExp(r, 'g'))
  const t = new RegExp('^' + i + '$'),
    e = new RegExp('^' + o + '$'),
    s = new RegExp('^[A-Z0-9 $%*+\\-./:]+$')
  return (
    (L.testKanji = function (u) {
      return t.test(u)
    }),
    ...
    Ht ||
      ...
      (function (o) {
        const r = $(),
          ...
          a = r.getBCHDigit(s)
        function u(C, h, S) {
          for (let w = 1; w <= 40; w++) if (h <= o.getCapacity(w, S, C)) return w
        }
        function c(C, h) {
        ...
        function A(C, h) {
          for (let S = 1; S <= 40; S++) if (m(C, S) <= o.getCapacity(S, h, t.MIXED)) return S
        }
        ;(o.from = function (h, S) {
          return e.isValid(h) ? parseInt(h, 10) : S
        }),
          (o.getCapacity = function (h, S, w) {
            if (!e.isValid(h)) throw new Error('Invalid QR Code version')
            typeof w > 'u' && (w = t.BYTE)
            const I = r.getSymbolTotalCodewords(h),
              d = i.getTotalCodewordsCount(h, S),
              f = (I - d) * 8
          ...
          (o.getEncodedBits = function (h) {
            if (!e.isValid(h) || h < 7) throw new Error('Invalid QR Code version')
            let S = h << 12
            for (; r.getBCHDigit(S) - a >= 0; ) S ^= s << (r.getBCHDigit(S) - a)
            return (h << 12) | S
          })
      })(lt)),
    lt
...
function Se() {
  ...
  const o = $(),
    ...
    n = o.getBCHDigit(r)
  return (
    (ht.getEncodedBits = function (e, s) {
      const a = (e.bit << 3) | s
      let u = a << 10
      for (; o.getBCHDigit(u) - n >= 0; ) u ^= r << (o.getBCHDigit(u) - n)
      return ((a << 10) | u) ^ i
    }),
    ht
  )
      ...
      (function (o) {
        var r = {
          ...
          extract_shortest_path_from_predecessor_list: function (i, n) {
            for (var t = [], e = n; e; ) t.push(e), i[e], (e = i[e])
            return t.reverse(), t
          },
          find_path: function (i, n, t) {
            var e = r.single_source_shortest_paths(i, n, t)
            return r.extract_shortest_path_from_predecessor_list(e, t)
          },
          PriorityQueue: {
            make: function (i) {
    ...
    Xt ||
      ...
      (function (o) {
        ...
        function m(d, f, g) {
          ...
          let P
          for (; (P = d.exec(g)) !== null; )
            l.push({ data: P[0], index: P.index, mode: f, length: P[0].length })
          return l
        }
        function A(d) {
          const f = m(s.NUMERIC, r.NUMERIC, d),
            g = m(s.ALPHANUMERIC, r.ALPHANUMERIC, d)
          let l, P
          return (
            a.isKanjiModeEnabled()
              ? ((l = m(s.BYTE, r.BYTE, d)), (P = m(s.KANJI, r.KANJI, d)))
              : ((l = m(s.BYTE_KANJI, r.BYTE, d)), (P = [])),
            f
              .concat(g, l, P)
              .sort(function (b, R) {
          ...
          for (let g = 0; g < d.length; g++) {
            ...
            switch (l.mode) {
              case r.NUMERIC:
                ...
                break
              case r.ALPHANUMERIC:
                f.push([l, { data: l.data, mode: r.BYTE, length: l.length }])
                break
              case r.KANJI:
                f.push([l, { data: l.data, mode: r.BYTE, length: c(l.data) }])
                break
              case r.BYTE:
                f.push([{ data: l.data, mode: r.BYTE, length: c(l.data) }])
            }
          }
          return f
        }
          ...
          for (let y = 0; y < d.length; y++) {
            ...
            for (let p = 0; p < b.length; p++) {
              ...
              for (let N = 0; N < P.length; N++) {
                const B = P[N]
                g[B] && g[B].node.mode === M.mode
                  ? ((l[B][E] = C(g[B].lastCount + M.length, M.mode) - C(g[B].lastCount, M.mode)),
                    (g[B].lastCount += M.length))
                  : (g[B] && (g[B].lastCount = M.length),
                    (l[B][E] = C(M.length, M.mode) + 4 + r.getCharCountIndicator(M.mode, f)))
              }
            }
            P = R
          }
          for (let y = 0; y < P.length; y++) l[P[y]].end = 0
 ...
 Suggested mode is: ` +
        ...
        ;(o.fromArray = function (f) {
          return f.reduce(function (g, l) {
            return (
              typeof l == 'string' ? g.push(I(l, null)) : l.data && g.push(I(l.data, l.mode)), g
            )
          }, [])
        }),
          (o.fromString = function (f, g) {
            const l = A(f, a.isKanjiModeEnabled()),
              P = S(l),
              y = w(P, g),
              b = u.find_path(y.map, 'start', 'end'),
              R = []
            for (let p = 1; p < b.length - 1; p++) R.push(y.table[b[p]].node)
            return o.fromArray(h(R))
          }),
          (o.rawSplit = function (f) {
            return o.fromArray(A(f, a.isKanjiModeEnabled()))
          })
      })(gt)),
    gt
  )
...
function qe() {
  ...
  function w(y, b) {
    const R = t.getPositions(b)
    for (let p = 0; p < R.length; p++) {
      const M = R[p][0],
        E = R[p][1]
      for (let N = -2; N <= 2; N++)
        for (let B = -2; B <= 2; B++)
          N === -2 || N === 2 || B === -2 || B === 2 || (N === 0 && B === 0)
            ? y.set(M + N, E + B, !0, !0)
            : y.set(M + N, E + B, !1, !0)
    }
  }
  ...
  function d(y, b, R) {
    const p = y.size,
      M = m.getEncodedBits(b, R)
    let E, N
    for (E = 0; E < 15; E++)
      (N = ((M >> E) & 1) === 1),
        E < 6 ? y.set(E, 8, N, !0) : E < 8 ? y.set(E + 1, 8, N, !0) : y.set(p - 15 + E, 8, N, !0),
        E < 8
          ? y.set(8, p - E - 1, N, !0)
          : E < 9
            ? y.set(8, 15 - E - 1 + 1, N, !0)
            : y.set(8, 15 - E - 1, N, !0)
    y.set(p - 8, 8, 1, !0)
  }
  function f(y, b) {
  ...
  function g(y, b, R) {
    ...
    const M = o.getSymbolTotalCodewords(y),
      E = a.getTotalCodewordsCount(y, b),
      N = (M - E) * 8
    for (p.getLengthInBits() + 4 <= N && p.put(0, 4); p.getLengthInBits() % 8 !== 0; ) p.putBit(0)
    const B = (N - p.getLengthInBits()) / 8
    for (let T = 0; T < B; T++) p.put(T % 2 ? 17 : 236, 8)
    return l(p, y, b)
  }
  function l(y, b, R) {
    const p = o.getSymbolTotalCodewords(b),
      M = a.getTotalCodewordsCount(b, R),
      E = p - M,
      N = a.getBlocksCount(b, R),
      B = p % N,
      T = N - B,
      F = Math.floor(p / N),
      H = Math.floor(E / N),
    ...
    let Mt = 0,
      D,
      _
    for (D = 0; D < W; D++) for (_ = 0; _ < N; _++) D < Y[_].length && (X[Mt++] = Y[_][D])
    for (D = 0; D < Nt; D++) for (_ = 0; _ < N; _++) X[Mt++] = St[_][D]
    return X
  }
  function P(y, b, R, p) {
    let M
    if (Array.isArray(y)) M = C.fromArray(y)
...
`
    ...
    return (
      ...
      b >= 7 && I(T, b),
      f(T, N),
      isNaN(p) && (p = s.getBestMask(T, d.bind(null, T, R))),
      s.applyMask(p, T),
      d(T, R, p),
      { modules: T, version: b, errorCorrectionLevel: R, maskPattern: p, segments: M }
    )
  }
  return (
    (et.create = function (b, R) {
      ...
      return (
        typeof R < 'u' &&
          ((p = r.from(R.errorCorrectionLevel, r.M)),
          (M = c.from(R.version)),
          (E = s.from(R.maskPattern)),
    ...
    te ||
      ...
      (function (o) {
        ...
        ;(o.getOptions = function (n) {
          n || (n = {}), n.color || (n.color = {})
          const t = typeof n.margin > 'u' || n.margin === null || n.margin < 0 ? 4 : n.margin,
            e = n.width && n.width >= 21 ? n.width : void 0,
            s = n.scale || 4
          return {
            width: e,
            scale: e ? 4 : s,
            margin: t,
            color: { dark: r(n.color.dark || '#000000ff'), light: r(n.color.light || '#ffffffff') },
            type: n.type,
          ...
          (o.qrToImageData = function (n, t, e) {
            const s = t.modules.size,
              a = t.modules.data,
              u = o.getScale(s, e),
              c = Math.floor((s + e.margin * 2) * u),
              m = e.margin * u,
              A = [e.color.light, e.color.dark]
            for (let C = 0; C < c; C++)
              for (let h = 0; h < c; h++) {
                let S = (C * c + h) * 4,
                  w = e.color.light
                if (C >= m && h >= m && C < c - m && h < c - m) {
                  const I = Math.floor((C - m) / u),
                    d = Math.floor((h - m) / u)
                  w = A[a[I * s + d] ? 1 : 0]
                }
      ...
      (function (o) {
        ...
        ;(o.render = function (e, s, a) {
          ...
          typeof u > 'u' && (!s || !s.getContext) && ((u = s), (s = void 0)),
            s || (c = n()),
            (u = r.getOptions(u))
          const m = r.getImageWidth(e.modules.size, u),
            A = c.getContext('2d'),
            C = A.createImageData(m, m)
    ...
    for (let A = 0; A < t.length; A++) {
      ...
      !C && !c && (c = !0),
        t[A]
          ? (m++,
            (A > 0 && C > 0 && t[A - 1]) ||
              ((a += c ? i('M', C + s, 0.5 + h + s) : i('m', u, 0)), (u = 0), (c = !1)),
            (C + 1 < e && t[A + 1]) || ((a += i('h', m)), (m = 0)))
          : u++
    }
    return a
  }
  return (
    (At.render = function (e, s, a) {
      const u = o.getOptions(s),
        c = e.modules.size,
        m = e.modules.data,
        A = c + u.margin * 2,
        C = u.color.light.a
          ? '<path ' + r(u.color.light, 'fill') + ' d="M0 0h' + A + 'v' + A + 'H0z"/>'
          : '',
        h = '<path ' + r(u.color.dark, 'stroke') + ' d="' + n(m, c, u.margin) + '"/>',
        S = 'viewBox="0 0 ' + A + ' ' + A + '"',
        I =
          '<svg xmlns="http://www.w3.org/2000/svg" ' +
          (u.width ? 'width="' + u.width + '" height="' + u.width + '" ' : '') +
          S +
...
function ke() {
      ...
      A === 2
        ...
        : A === 3 &&
          (s.getContext && typeof c > 'u'
            ? ((c = u), (u = void 0))
            : ((c = u), (u = a), (a = s), (s = void 0)))
    } else {
      if (A < 1) throw new Error('Too few arguments provided')
      return (
        A === 1
          ? ((a = s), (s = u = void 0))
          : A === 2 && !s.getContext && ((u = a), (a = s), (s = void 0)),
        new Promise(function (h, S) {
          try {
  ...
  return (
    (K.create = r.create),
    (K.toCanvas = t.bind(null, i.render)),
    (K.toDataURL = t.bind(null, i.renderToDataURL)),
    (K.toString = t.bind(null, function (e, s, a) {
      return n.render(e, a)
    })),
    K
  )
...
function Oe(o, r) {
  const i = Array.prototype.slice.call($e.create(o, { errorCorrectionLevel: r }).modules.data, 0),
    n = Math.sqrt(i.length)
...
var U = function (o, r, i, n) {
  var t = arguments.length,
    e = t < 3 ? r : n === null ? (n = Object.getOwnPropertyDescriptor(r, i)) : n,
    s
  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
    e = Reflect.decorate(o, r, i, n)
  else
    for (var a = o.length - 1; a >= 0; a--)
      (s = o[a]) && (e = (t < 3 ? s(e) : t > 3 ? s(r, i, e) : s(r, i)) || e)
...
let v = class extends me {
  ...
  templateVisual() {
    return this.imageSrc
      ? j`<wui-image src=${this.imageSrc} alt=${this.alt ?? 'logo'}></wui-image>`
      : this.farcaster
        ? j`<wui-icon
        class="farcaster"
        size="inherit"
        ...
        name="farcaster"
      ></wui-icon>`
        : j`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`
  }
}
v.styles = [ge, He]
U([z()], v.prototype, 'uri', void 0)
U([z({ type: Number })], v.prototype, 'size', void 0)
U([z()], v.prototype, 'theme', void 0)
U([z()], v.prototype, 'imageSrc', void 0)
U([z()], v.prototype, 'alt', void 0)
U([z()], v.prototype, 'color', void 0)
U([z({ type: Boolean })], v.prototype, 'arenaClear', void 0)
U([z({ type: Boolean })], v.prototype, 'farcaster', void 0)
