import { c as d, r as u } from './if-defined-DVOmkLu5.js'
import { x as e, r as h, R as l, l as o, i as p } from './index-DVkBgnkX.js'
import { T as g } from './index-swSfGf8i.js'

import { r as u, c as d } from './if-defined-DVOmkLu5.js'
import { T as g } from './index-swSfGf8i.js'
const f = p`
  :host {
    --prev-height: 0px;
...
`
var v = function (s, t, i, r) {
  var w = arguments.length,
    n = w < 3 ? t : r === null ? (r = Object.getOwnPropertyDescriptor(t, i)) : r,
    c
  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
    n = Reflect.decorate(s, t, i, r)
  else
    for (var m = s.length - 1; m >= 0; m--)
      (c = s[m]) && (n = (w < 3 ? c(n) : w > 3 ? c(t, i, n) : c(t, i)) || n)
...
let a = class extends h {
  ...
  firstUpdated() {
    ...
    ;(this.resizeObserver = new ResizeObserver(([i]) => {
      const r = `${i == null ? void 0 : i.contentRect.height}px`
      this.prevHeight !== '0px' &&
        (this.style.setProperty('--prev-height', this.prevHeight),
        this.style.setProperty('--new-height', r),
      ...
      (t = this.resizeObserver) == null || t.observe(this.getWrapper())
  }
  disconnectedCallback() {
    var t
    ;(t = this.resizeObserver) == null || t.unobserve(this.getWrapper()),
  ...
  onViewChange(t) {
    ...
    const { history: r } = l.state
    r.length < this.prevHistoryLength && (i = o.VIEW_DIRECTION.Prev),
  ...
  getWrapper() {
    var t
    return (t = this.shadowRoot) == null ? void 0 : t.querySelector('div')
  }
}
a.styles = f
v([u()], a.prototype, 'view', void 0)
v([u()], a.prototype, 'viewDirection', void 0)
a = v([d('w3m-router')], a)
export { a as W }
