import { o as P, c as g, r as p, n as w } from './if-defined-DVOmkLu5.js'
import './index-B2osUT2V.js'
import './index-BGjtclTS.js'
import './index-BfDAOq8h.js'
import { N as k } from './index-BxwsSeIL.js'
import { n as H, e as z } from './index-Cn1TwpSs.js'
...
import { r as p, c as g, n as w, o as P } from './if-defined-DVOmkLu5.js'
import { N as k } from './index-BxwsSeIL.js'
import { e as z, n as H } from './index-Cn1TwpSs.js'
import './index-B2osUT2V.js'
import './index-BfDAOq8h.js'
import './index-BGjtclTS.js'
import './index-Cxc8tIRM.js'
...
var U = function (o, e, i, n) {
  var s = arguments.length,
    t = s < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, i)) : n,
    r
  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
    t = Reflect.decorate(o, e, i, n)
  else
    for (var a = o.length - 1; a >= 0; a--)
      (r = o[a]) && (t = (s < 3 ? r(t) : s > 3 ? r(e, i, t) : r(e, i)) || t)
...
let v = class extends f {
    ...
    super(),
      ...
      this.unsubscribe.push(
        E.subscribeKey('open', e => {
          e || (this.onHideIframe(), I.popTransactionStack())
        }),
  ...
  async firstUpdated() {
    ...
    const e =
      (i = this == null ? void 0 : this.renderRoot) == null ? void 0 : i.querySelector('div')
    ;(this.bodyObserver = new ResizeObserver(n => {
      var r, a
      const s = (r = n == null ? void 0 : n[0]) == null ? void 0 : r.contentBoxSize,
        t = (a = s == null ? void 0 : s[0]) == null ? void 0 : a.inlineSize
      ;(this.iframe.style.height = `${S}px`),
        ...
        t && t <= 430
          ...
          : ((this.iframe.style.width = `${N}px`),
            (this.iframe.style.left = `calc(50% - ${N / 2}px)`),
            (this.iframe.style.top = `calc(50% - ${S / 2}px + ${F / 2}px)`),
  ...
  async syncTheme() {
    ...
    if (e) {
      const i = A.getSnapshot().themeMode,
        n = A.getSnapshot().themeVariables
      await e.provider.syncTheme({ themeVariables: n, w3mThemeVariables: M(n, i) })
    }
  }
}
v.styles = V
U([p()], v.prototype, 'ready', void 0)
v = U([g('w3m-approve-transaction-view')], v)
...
_ = G([g('w3m-upgrade-wallet-view')], _)
const Y = x`
  :host {
    position: relative;
    width: 100%;
...
let u = class extends f {
  constructor() {
    super(),
      ...
      (this.name = ''),
      (this.error = ''),
      (this.loading = c.state.loading),
      (this.suggestions = c.state.suggestions),
      (this.registered = !1),
      (this.profileName = h.state.profileName),
      (this.onDebouncedNameInputChange = O.debounce(e => {
        c.validateName(e)
          ? ((this.error = ''),
            (this.name = e),
            c.getSuggestions(e),
            c.isNameRegistered(e).then(i => {
              this.registered = i
            }))
          : e.length < 4
  ...
  disconnectedCallback() {
    ...
    super.disconnectedCallback(),
      this.usubscribe.forEach(i => i()),
      (e = this.formRef.value) == null ||
        e.removeEventListener('keydown', this.onEnterKey.bind(this))
  }
  render() {
    return l`
      <wui-flex
  ...
  isAllowedToSubmit() {
    return (
      ...
      !this.error &&
      !this.profileName &&
      c.validateName(this.name)
    )
  }
  async onSubmitName() {
    try {
      if (!this.isAllowedToSubmit()) return
      const e = `${this.name}${$.WC_NAME_SUFFIX}`
      y.sendEvent({
        type: 'track',
        event: 'REGISTER_NAME_INITIATED',
        properties: {
          isSmartAccount: h.state.preferredAccountType === T.ACCOUNT_TYPES.SMART_ACCOUNT,
          ensName: e
        }
      }),
        await c.registerName(e),
        y.sendEvent({
          type: 'track',
...
u.styles = L
m([w()], u.prototype, 'errorMessage', void 0)
m([p()], u.prototype, 'name', void 0)
m([p()], u.prototype, 'error', void 0)
m([p()], u.prototype, 'loading', void 0)
m([p()], u.prototype, 'suggestions', void 0)
m([p()], u.prototype, 'registered', void 0)
m([p()], u.prototype, 'profileName', void 0)
u = m([g('w3m-register-account-name-view')], u)
const B = x`
...
R.styles = B
R = K([g('w3m-register-account-name-success-view')], R)
export {
